...
export async function main(ns: NS) {
  ...
  //     noodles: getIdealWeakenThreadCountForOneIteration(ns, 'n00dles'),
  //     food: getIdealWeakenThreadCountForOneIteration(ns, 'foodnstuff'),
  //     sigma: getIdealWeakenThreadCountForOneIteration(ns, 'sigma-cosmetics'),
  //     joe: getIdealWeakenThreadCountForOneIteration(ns, 'joesguns'),
  //     tea: getIdealWeakenThreadCountForOneIteration(ns, 'hong-fang-tea'),
  //     sushi: getIdealWeakenThreadCountForOneIteration(ns, 'harakiri-sushi'),
  //     iron: getIdealWeakenThreadCountForOneIteration(ns, 'iron-gym'),
  //   });
  ...
  // max time from result
  //   const sleepTimeBeforePrinting = Object.keys(weaks).reduce((res, curr) => {
  //     const time = weaks[curr].weakenTime;
  //     return time > res ? time : res;
  //   }, 0);
   ...
   * Grow
   */
  //   Object.keys(grows).forEach((key) => {
  //     //@ts-expect-error:: key is typeof string
  //     const threads: number = grows[key].threadCount;
  //     console.log({ threads });
  //     if (threads === 0) {
  //       console.log(`${key} already at max grow`);
  //       return;
  //     }
  //     ns.exec('grow.js', 'home', threads, key);
  //   });
  //   console.log(await grow());

  /**
   * Hack
   */
  //   Object.keys(hacks).forEach((key) => {
  //     //@ts-expect-error:: key is typeof string
  //     const threads: number = hacks[key].threadCount;
  //     console.log({ threads });
  //     if (threads === 0) {
  //       console.log(`${key} already at min money`);
  //       return;
  //     }
  //     ns.exec('hack.js', 'home', threads, key);
  //   });
  ...
  // ns.exec('early-hack-template.js',"n00dles", timing.noodles)
  // ns.exec('early-hack-template.js',"n00dles", timing.noodles)
